...
/**
 * Created by idnvra on 04-08-2014.
 */
public class SelectionSortTest {
    ...
    public void testSelectionSortAsc(){
        ...
        Assert.assertArrayEquals("Values did not match",sortedValues, SelectionSort.asc(integerValues));
    }
    @Test
    public void testSelectionSortDesc(){
        int[] integerValues = {4,3,1,7,5,2,6};
        int[] sortedValues = {7,6,5,4,3,2,1};
        Assert.assertArrayEquals("Values did not match",sortedValues, SelectionSort.desc(integerValues));
    }
    @Test
